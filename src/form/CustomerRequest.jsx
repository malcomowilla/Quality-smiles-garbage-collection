...
<div className=' text-black mb-10 inconsolata sm:text-5xl max-sm:text-4xl   tracking-widest'>
    ...
    <h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-white "> Confirm Your Request  </h2>
<div>
  ...
  <option disabled selected> Bag Full?</option>
  <option>Yes Full</option>
  <option>Half Full But Still Want Collection</option>
