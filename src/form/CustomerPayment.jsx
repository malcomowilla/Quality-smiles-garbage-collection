...
const CustomerPayment = () => {
  ...
  const paymentMethods = [
    {
      ...
      image: '/images/MicrosoftTeams-image.jpg',
      alt: 'mpesa'
    },
    {
      name: 'Airtel Money',
  ...
  const mpesaInstructions = [
    ...
    { text: 'Select Paybill' },
    { text: 'Enter', bold: '384040', suffix: 'As Business Number' },
    { text: 'Enter', bold: 'Malcom Owilla', suffix: 'As Account Number' },
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-wrap lg:flex-nowrap gap-8">
        ...
        <motion.div 
          ...
          animate={{ x: 0 }}
        >
          <h2 className="text-xl font-bold text-gray-900 mb-2 playwrite-de-grund">Add Credits</h2>
